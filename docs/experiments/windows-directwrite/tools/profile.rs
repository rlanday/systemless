//! Deterministic SC2K replay. All timing rows and screenshots are flushed after
//! measurement. This measures frame CPU work, not scanout or GUI scheduling.
    ...
    for frame in 0..1100 {
        ...
        if frame == 499 {
            ...
            for (rw,rh) in [(800,600),(1104,828),(800,600)] {
                ...
                screenshots.push((format!("dialog-{rw}x{rh}-{}.png",screenshots.len()),rw,rh,scaled.clone()));
            }
        }
    }
