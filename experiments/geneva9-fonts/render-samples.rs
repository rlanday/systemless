...
fn main() {
    ...
    for (y,text) in [
        (20,"Power Plant Needed"),(42,"Power Plant Needed  WWW www  Ill lll  p a s"),
        (64,"abcdefghijklmnopqrstuvwxyz"),(86,"ABCDEFGHIJKLMNOPQRSTUVWXYZ"),
        (108,"0123456789 !?.,:; ()[]{} /+-= @#$%&"),
        (130,"The quick brown fox jumps over the lazy dog."),
        (152,"Silly little willow: lower power, plain plans.")
    ] {
