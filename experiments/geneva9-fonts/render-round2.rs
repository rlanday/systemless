...
fn samples() {
    ...
    for (y,text) in [
        ...
        (40,"city cities civic circle  it iz ci ic ii"),
        (60,"Demand  Road&Rail  Tool Tools  To oo ol"),
        (80,"human humane hammer  h n m  nh hn hm mh"),
        (100,"little silk milk look  kl lk ll li il  ij ji"),
        (120,"river ruler street  r n m t l  s e o a"),
        (140,"Power Plant Needed  little city minimum"),
        (160,"The quick brown fox jumps over the lazy dog."),
    ...
    b.write_pstring(0x11000,b"Centering Tool  Tool To oo ol");c.write_reg(Register::A7,0x10000);b.write_long(0x10000,0x11000);d.dispatch(0xa884,&mut c,&mut b).unwrap();
